...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        'relative group/bento shadow-input row-span-1 flex flex-col justify-between space-y-4 rounded-xl border border-neutral-200 bg-background p-4 transition duration-200 hover:shadow-xl dark:border-white/[0.2] dark:bg-black dark:shadow-none cursor-pointer isolate',
        className
      )}
    >
      {header}
