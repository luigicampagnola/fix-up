        ...
        <div className={`flex flex-col w-full justify-${titlePosition}`}>
          {button && (
            <div className='flex pb-5 justify-center lg:justify-start text-white'>
              <Link
                className='text-[14px] md:text-[15px] lg:text-[16px] pr-2 hover:text-forestgreen'
                href={button.url}
              >
                {button.label}
              </Link>
              {/* <FaAngleRight className="text-[24px]" /> */}
              <p className='text-[14px] md:text-[15px] lg:text-[16px] pl-2'>
                Blog Details
              </p>
            </div>
          )}
          ...
          <div className='flex pt-5 justify-center lg:justify-start items-center'>
            ...
            <p className='ml-3 text-[14px] md:text-[15px] lg:text-[16px] text-white'>
              {date}
            </p>
          </div>
        </div>
