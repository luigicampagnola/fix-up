...
export default function BottomBar({
  ...
  return (
    <section className="bg-midnightblue w-full flex text-[14px] md:text-[15px] lg:text-[16px] font-normal text-black justify-center">
      <div className="font-semibold w-11/12 basis-11/12 md:basis-10/12 md:w-10/12 lg:basis-9/12 lg:w-9/12 text-white flex flex-wrap md:flex-row items-center lg:max-w-7xl">
        {copyright && (
