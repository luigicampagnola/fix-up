...
export default function CardWidget({
  ...
  return (
    <div
      ref={cardRef}
      className={`box-widget desktop:w-4/12 desktop:basis-4/12 flex flex-col transition-all duration-1000 ease-out ${
      ...
      <div className='bg-white rounded-lg flex-1 flex flex-col mb-3 md:mb-5 mx-3'>
        ...
        <div className='px-5 md:px-8 pb-8'>
          <h3 className='text-xl md:text-2xl pt-8 pb-5 text-midnightblue font-bold leading-tight'>
            {title} <span className='desktop:block'>{subtitle}</span>
          </h3>
