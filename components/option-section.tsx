    ...
    <section className="option-section bg-platinum w-full flex text-[14px] md:text-[15px] lg:text-[16px] font-normal text-black justify-center">
      <div className=" basis-11/12 w-11/12 lg:basis-10/12 lg:w-10/12 py-[100] flex flex-col items-center">
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full p-[20px] basis-full lg:w-1/2 lg:basis-1/2">
            <p className="pb-[10px]">{middleDescription}</p>
            <p>{descriptionWithLink}</p>
          </div>
          } 
        </div>
        {!descriptionWithLink && middleDescription && <p className="pt-5 pb-[15px] text-center lg:text-left">{middleDescription}</p>}
